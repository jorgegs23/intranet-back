...
public class MessageResponseDto<T> {
	...
	/**
	 * * Return fail. * * @param <T> the generic type * @param message the message
	...
	/**
	 * * Return success. * * @param <T> the generic type * @param content the
	 * content * @return the message response dto
	 */
